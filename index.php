...
<?php include 'blocks/nav.php'; ?>
    ...
    <section class="catalog section">
        <div class="container">
            ...
            <div class="products-wrap">
                <div class="catalog__item products__card" style="background-image: url('/img/products/product-1.jpg')"><a class="products__card-link" href="/product.html"></a></div>
                <div class="catalog__item products__card" style="background-image: url('/img/products/product-2.jpg')"><a class="products__card-link" href="/product.html"></a></div>
                <div class="catalog__item products__card" style="background-image: url('/img/products/product-3.jpg')"><a class="products__card-link" href="/product.html"></a></div>
                <div class="catalog__item products__card" style="background-image: url('/img/products/product-4.jpg')"><a class="products__card-link" href="/product.html"></a></div>
            </div>
            <p><a class="products__look-all" href="/catalog.html">Смотреть весь каталог</a></p>
        </div>
    </section>
    ...
    <section class="gallery section">
        <div class="container">
            ...
            <div class="products-wrap">
                <div class="gallery__item products__card" style="background-image: url('/img/gallery/photo-1.jpg')"><a class="products__card-link" href="/gallery.html"></a></div>
                <div class="gallery__item products__card" style="background-image: url('/img/gallery/photo-2.jpg')"><a class="products__card-link" href="/gallery.html"></a></div>
                <div class="gallery__item products__card" style="background-image: url('/img/gallery/photo-3.jpg')"><a class="products__card-link" href="/gallery.html"></a></div>
                <div class="gallery__item products__card" style="background-image: url('/img/gallery/photo-4.jpg')"><a class="products__card-link" href="/gallery.html"></a></div>
            </div>
            <p><a class="products__look-all" href="/gallery.html">Смотреть все фото</a></p>
        </div>
    </section>
